...
function App() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex flex-col items-center justify-center bg-gray-100 text-gray-900 px-4">
      ...
      <div className="text-center max-w-3xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
          ...
          <Button
            size="lg"
            className="bg-red-600 hover:bg-red-700 text-gray-900 h-14 px-8 text-lg font-bold transition-all hover:scale-105"
            onClick={handleGetStarted}
          >
            {authStatus ? "Browse Products" : "Get Started"}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 max-w-6xl w-full text-left">
        ...
        <div className="p-6 rounded-2xl bg-slate-900/50 border border-white/5">
          ...
          <p className="text-slate-400 text-sm">
            Seamlessly link Google or Facebook to your existing account.
          </p>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-slate-900/50 border border-white/5">
          ...
          <p className="text-slate-400 text-sm">
            Automated cron jobs manage your 1h, 6h, or 12h access levels.
          </p>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-slate-900/50 border border-white/5">
          ...
          <p className="text-slate-400 text-sm">
            Auto-suggest addresses and display your profile location on a map.
          </p>
        </div>
