            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="flex items-center outline-none cursor-pointer group">
                  <img src={user.picture || "https://img.icons8.com/?size=100&id=7819&format=png&color=000000"} alt="Avatar" className="h-10 w-10 rounded-full border-2 border-slate-700 group-hover:border-red-600 transition-all object-cover" />
                </div>
              </DropdownMenuTrigger>
